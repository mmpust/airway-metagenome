...
pcaInd_patternRec_strepto <- fviz_pca_ind(pca_patternRec_strepto, geom.ind = c("text", "point"), 
                                          pointsize = 2, palette = c("palegreen4", "black", "grey"),
...
# Export plots
ggsave("image_output/Fig_3.tif", plot_heat_all, device = "tiff", dpi= 600,
       width = 8.8, height = 12)

ggsave("image_output/Supplementary_Fig_7.tif", pca_plots, device = "tiff", dpi = 300, 
       width = 12, height = 8.36)

ggsave("image_output/Supplementary_Fig_6.tif", all_hier, device = "tiff", dpi = 300,

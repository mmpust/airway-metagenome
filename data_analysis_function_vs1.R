...
ActIsr <- read_delim("data_input/gapseq_RDS/step_1/ActIsr_pathways_reactions.csv", ";", 
...
CamCon <- read_delim("data_input/gapseq_RDS/step_1/CamCon_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
CapEnd <- read_delim("data_input/gapseq_RDS/step_1/CapEnd_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
CapSpu <- read_delim("data_input/gapseq_RDS/step_1/CapSpu_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
FusNuc <- read_delim("data_input/gapseq_RDS/step_1/FusNuc_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
GemHae <- read_delim("data_input/gapseq_RDS/step_1/GemHae_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
GemMor <- read_delim("data_input/gapseq_RDS/step_1/GemMor_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
GemSan <- read_delim("data_input/gapseq_RDS/step_1/GemSan_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
HaeHae <- read_delim("data_input/gapseq_RDS/step_1/HaeHae_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
HaePar <- read_delim("data_input/gapseq_RDS/step_1/HaePar_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
LepBuc <- read_delim("data_input/gapseq_RDS/step_1/LepBuc_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
LepHof <- read_delim("data_input/gapseq_RDS/step_1/LepHof_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
LepHon <- read_delim("data_input/gapseq_RDS/step_1/LepHon_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
LepWad <- read_delim("data_input/gapseq_RDS/step_1/LepWad_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
NeiMuc <- read_delim("data_input/gapseq_RDS/step_1/NeiMuc_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
NeiPol <- read_delim("data_input/gapseq_RDS/step_1/NeiPol_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
NeiSic <- read_delim("data_input/gapseq_RDS/step_1/NeiSic_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
NeiSub <- read_delim("data_input/gapseq_RDS/step_1/NeiSub_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
PorAsa <- read_delim("data_input/gapseq_RDS/step_1/PorAsa_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
PreJej_II <- read_delim("data_input/gapseq_RDS/step_1/PreJej_II_pathways_reactions.csv", ";", 
                        escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                                pathway_completeness = col_number(), 
                                                                pathway_completeness_perc = col_number(), 
                                                                pathway_key_reactions = col_character()), trim_ws = TRUE)
...
PreJej <- read_delim("data_input/gapseq_RDS/step_1/PreJej_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
PreMel_II <- read_delim("data_input/gapseq_RDS/step_1/PreMel_II_pathways_reactions.csv", ";", 
                        escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                                pathway_completeness = col_number(), 
                                                                pathway_completeness_perc = col_number(), 
                                                                pathway_key_reactions = col_character()), trim_ws = TRUE)
...
PreMel <- read_delim("data_input/gapseq_RDS/step_1/PreMel_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
PreOri <- read_delim("data_input/gapseq_RDS/step_1/PreOri_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
PreRum <- read_delim("data_input/gapseq_RDS/step_1/PreRum_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
PrevEno <- read_delim("data_input/gapseq_RDS/step_1/PrevEno_pathways_reactions.csv", ";", 
                      escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                              pathway_completeness = col_number(), 
                                                              pathway_completeness_perc = col_number(), 
                                                              pathway_key_reactions = col_character()), trim_ws = TRUE)
...
PseGoo <- read_delim("data_input/gapseq_RDS/step_1/PseGoo_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
RotMuc <- read_delim("data_input/gapseq_RDS/step_1/RotMuc_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
SchMey <- read_delim("data_input/gapseq_RDS/step_1/SchMey_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
SchOdo <- read_delim("data_input/gapseq_RDS/step_1/SchOdo_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
StrAus <- read_delim("data_input/gapseq_RDS/step_1/StrAus_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
StrEqu <- read_delim("data_input/gapseq_RDS/step_1/StrEqu_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
StrGor <- read_delim("data_input/gapseq_RDS/step_1/StrGor_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
StrHim <- read_delim("data_input/gapseq_RDS/step_1/StrHim_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
StrMit <- read_delim("data_input/gapseq_RDS/step_1/StrMit_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
StrOra <- read_delim("data_input/gapseq_RDS/step_1/StrOra_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
StrPar <- read_delim("data_input/gapseq_RDS/step_1/StrPar_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
StrPne <- read_delim("data_input/gapseq_RDS/step_1/StrPne_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
StrSal <- read_delim("data_input/gapseq_RDS/step_1/StrSal_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
StrVes <- read_delim("data_input/gapseq_RDS/step_1/StrVes_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
VeiAty <- read_delim("data_input/gapseq_RDS/step_1/VeiAty_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
VeiDis <- read_delim("data_input/gapseq_RDS/step_1/VeiDis_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
VeiPar <- read_delim("data_input/gapseq_RDS/step_1/VeiPar_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
VeiRod <- read_delim("data_input/gapseq_RDS/step_1/VeiRod_pathways_reactions.csv", ";", 
                     escape_double = FALSE, col_types = cols(pathway_candidate_reaction = col_character(), 
                                                             pathway_completeness = col_number(), 
                                                             pathway_completeness_perc = col_number(), 
                                                             pathway_key_reactions = col_character()), trim_ws = TRUE)
...
pcaInd_patternRec_strepto <- fviz_pca_ind(pca_patternRec_strepto, geom.ind = c("text", "point"), 
                                          pointsize = 2, palette = c("palegreen4", "black", "peru"),
...
StrAus_stress <- read.csv("StrAus_stress.tbl", sep = "\t")
...
StrPar_stress <- read.csv("StrPar_stress.tbl", sep="\t")
...
StrAus_adhesion <- read.csv("StrAus_adhesion.tbl", sep = "\t")
...
StrPar_adhesion <- read.csv("StrPar_adhesion.tbl", sep="\t")
...
# Export plots
#ggsave("image_output/Figure_03.tif", plot_heat_all, device = "tiff", dpi= 600,
 #      width = 8.8, height = 12)

#ggsave("image_output/Figure_04.tif", pca_plots, device = "tiff", dpi = 600, 
 #      width = 12, height = 8.36)

#ggsave("image_output/Supplementary_FigureX.tif", all_hier, device = "tiff", dpi = 300,
 #      width = 8.46, height = 8.52)

#ggsave("image_output/Supplementary_FigureXX.tif", SA_vs_SP, device = "tiff", dpi = 300,
